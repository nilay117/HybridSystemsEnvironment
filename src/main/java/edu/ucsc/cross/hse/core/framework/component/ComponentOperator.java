...
public class ComponentOperator extends ComponentWorker
{
	...
	/*
	 * Gets the generated key from the current instance of the environment that
	...
	public ArrayList<Component> jumpingComponents()
	{
		...
		for (Component localBehavior : component.getContents().getObjects(Component.class, true, HybridSystem.class)) // check
																														// through
																														// all
																														// components
																														// where
