...
public class Data<T> extends Component// DynamicData<T>
{
	...
	// // public because they access previosly stored data, which may or may not
	// be
	// // allowed depending on the situation. If a vehicle is traveling around
	// // without a storage device or any means to record data, it would not
	// have
	...
	//
	// ///////////////////////////////////////////////////////////////////////////////////////////////////
	// // Internal Operation Functions : everything below for the processing
	// system
