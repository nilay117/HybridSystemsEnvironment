...
import edu.ucsc.cross.hse.core.framework.data.DataWorker;
...
@SuppressWarnings(
{ "unchecked", "rawtypes" })
public class Dat<T> extends Component// DynamicData<T>
{
	 ...
	 */
	protected Dat(T obj, DataTypeProperties type, String name, String description, Boolean save_default)
	{
	...
	protected static <S> Dat instantiate(S obj, DataTypeProperties type, String name, String description,
	Boolean save_default)
	{
		Dat<S> newData = new Dat<S>(obj, type, name, description, save_default);
		return newData;
	}
