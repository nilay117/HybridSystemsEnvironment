...
/**
 * A renderer that connects data points with lines and/or draws shapes at each data point. This renderer is designed for
 * use with the {@link XYPlot} class. The example shown here is generated by the
 * <code>XYLineAndShapeRendererDemo2.java</code> program included in the JFreeChart demo collection: <br>
 * <br>
 * <img src="../../../../../images/XYLineAndShapeRendererSample.png" alt="XYLineAndShapeRendererSample.png">
 *
 */
public class HybridXYLineAndShapeRenderer extends AbstractXYItemRenderer
implements XYItemRenderer, Cloneable, PublicCloneable, Serializable
{
	 ...
	 */
	public HybridXYLineAndShapeRenderer()
	{
		this(true, true);
	}
	 ...
	 *            shapes visible?
	 */
	public HybridXYLineAndShapeRenderer(boolean lines, boolean shapes)
	{
	...
	int series, int item, ValueAxis domainAxis, ValueAxis rangeAxis, Rectangle2D dataArea)
	{
		...
		if (x1 != x0)
		{
			...
			g2.setStroke(this.getSeriesStroke(series));// stroke1);
			// g2.setStroke(s);
		} else
		{
			float dash1[] =
			{ 10.0f };
			Stroke stroke1 = new BasicStroke(.5f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 1.0f, dash1, 2.0f);
	 ...
	 * positions. If <code>entities</code> is not <code>null</code> it will be populated with entity information for
	...
	{
		HybridXYLineAndShapeRenderer clone = (HybridXYLineAndShapeRenderer) super.clone();
	...
	public boolean equals(Object obj)
	{
		...
		if (!(obj instanceof HybridXYLineAndShapeRenderer))
		{
			return false;
		}
		if (!super.equals(obj))
		...
		HybridXYLineAndShapeRenderer that = (HybridXYLineAndShapeRenderer) obj;
